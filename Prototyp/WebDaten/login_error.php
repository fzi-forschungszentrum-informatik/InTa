 ...
 * Die login_error.php wird angezeigt wenn beim login ein Fehler auftrat.
 */
...
<!-- Content-Start -->
<div id="content">
<center><?php if (isset($_GET['error'])) {echo '<p class="error" style="color:white">Beim einloggen trat ein Fehler auf, bitte überprüfen Sie Ihre Eingabe!</p>';}?></center>
    <div id="form">
