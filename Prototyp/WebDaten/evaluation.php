 ...
 * Masterthesis
 * - Erweiterung von Standardpr&auml;sentationssoftware zur F&ouml;rderung der Publikumsinteraktion -
 ...
 * Die evaluation.php dient zur Anzeige der Evaluationsfragen, die dem Nutzer auf dem Smartphone angezeigt werden.
...
<div data-role="page" id="page2" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 1: Anwendung (Frage 1 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
	
  <div data-role="main" class="ui-content">
  <center><p>Bitte bewerten Sie die folgenden Aussagen:</p><br \>
  <p>Die Anwendung hat tadellos funktioniert.</p>
...
<div data-role="page" id="page3" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 1: Anwendung (Frage 2 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
	
  <div data-role="main" class="ui-content">
  <center><p>Bitte bewerten Sie die folgenden Aussagen:</p><br \>
  <p>Die Funktionalit&auml;t der Anwendung ist ausreichend.</p>
  <form id="form"><label for="slider">(Skala von 0 trifft &uuml;berhaupt nicht zu bis 10 trifft voll und ganz zu)</label>
...
<div data-role="page" id="page4" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 1: Anwendung (Frage 3 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
	
  <div data-role="main" class="ui-content">
  <center><p>Bitte bewerten Sie die folgenden Aussagen:</p><br \>
  <p>Die Bedienung der Anwendung ist einfach und intuitiv.</p>
  <form id="form"><label for="slider">(Skala von 0 trifft &uuml;berhaupt nicht zu bis 10 trifft voll und ganz zu)</label>
...
<div data-role="page" id="page5" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 1: Anwendung (Frage 4 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
	
  <div data-role="main" class="ui-content">
  <center><p>Bitte bewerten Sie die folgenden Aussagen:</p><br \>
  <p>Die Gestaltung der Anwendung ist ansprechend.</p>
  <form id="form"><label for="slider">(Skala von 0 trifft &uuml;berhaupt nicht zu bis 10 trifft voll und ganz zu)</label>
...
<div data-role="page" id="page6" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 1: Anwendung (Frage 5 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
...
<div data-role="page" id="page7" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 2: Audience Response Systeme (Frage 6 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
...
<div data-role="page" id="page8" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 2: Audience Response Systeme (Frage 7 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
	
  <div data-role="main" class="ui-content">
  <center><p>Bitte bewerten Sie die folgenden Aussagen:</p><br \>
  <p>Ich habe bereits eine solche Anwendung genutzt.</p>
  <form id="form"><label for="slider">(Skala von 0 trifft &uuml;berhaupt nicht zu bis 10 trifft voll und ganz zu)</label>
...
<div data-role="page" id="page9" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 2: Audience Response Systeme (Frage 8 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
	
  <div data-role="main" class="ui-content">
  <center><p>Bitte bewerten Sie die folgenden Aussagen:</p><br \>
  <p>Ein solches System sollte in zuk&uuml;nftigen Vorlesungen &ouml;fters zum Einsatz kommen.</p>
  <form id="form"><label for="slider">(Skala von 0 trifft &uuml;berhaupt nicht zu bis 10 trifft voll und ganz zu)</label>
...
<div data-role="page" id="page10" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 2: Audience Response Systeme (Frage 9 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
	
  <div data-role="main" class="ui-content">
  <center><p>Bitte bewerten Sie die folgenden Aussagen:</p><br \>
  <p>Ein solches System f&ouml;rdert die Aufmerksamkeit in der Vorlesung</p>
  <form id="form"><label for="slider">(Skala von 0 trifft &uuml;berhaupt nicht zu bis 10 trifft voll und ganz zu)</label>
...
<div data-role="page" id="page11" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 2: Audience Response Systeme (Frage 10 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
	
  <div data-role="main" class="ui-content">
  <center><p>Bitte bewerten Sie die folgenden Aussagen:</p><br \>
  <p>Ein solches System f&ouml;rdert die Interaktion zwischen Redner und Student</p>
  <form id="form"><label for="slider">(Skala von 0 trifft &uuml;berhaupt nicht zu bis 10 trifft voll und ganz zu)</label>
...
<div data-role="page" id="page12" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 3: Allgemein (Frage 11 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
...
<div data-role="page" id="page13" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 3: Allgemein (Frage 12 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
...
<div data-role="page" id="page14" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 3: Allgemein (Frage 13 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
...
<div data-role="page" id="page15" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 3: Allgemein (Frage 14 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
...
<div data-role="page" id="page16" class="page">
  ...
  <div data-role="header" class="header">
  <h1>Block 3: Allgemein (Frage 15 / 15)</h1>
  <a href="#info"><i class="fa fa-bars fa-2x"></i></a>
  </div>
...
{
	var answer = \'q1:\'+$("#answer1").val()+\'q2:\'+$("#answer2").val()+\'q3:\'+$("#answer3").val()+\'q4:\'+$("#answer4").val()+\'q5:\'+$("#answer5").val()+\'q6:\'+$("#answer6").val()+\'q7:\'+$("#answer7").val()+\'q8:\'+$("#answer8").val()+\'q9:\'+$("#answer9").val()+\'q10:\'+$("#answer10").val()+\'q11:\'+$("#answer11").val()+\'q12:\'+$("#answer12").val()+\'q13:\'+$("#answer13").val()+\'q14:\'+$("#answer14").val()+\'q15:\'+$("#answer15").val();
